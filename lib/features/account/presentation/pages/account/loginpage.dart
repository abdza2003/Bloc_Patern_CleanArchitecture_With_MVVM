            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    height: 5.h,
                    child: isAnother?Text("NOTE_SECOND_LOGIN".tr(context),style: TextStyle(fontSize: 12.sp),):const SizedBox(),
                  ),
                          ...
                          Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  // errorText: login.userErrorText,
                                  hintText: "LOGIN_PASSWORD_HINT".tr(context),
                                ...
                                if (formKey.currentState!.validate()) {
                                  if (isAnother) {
                                    BlocProvider.of<AccountBloc>(context).add(
                                        SecondLoginEvent(usernameOrEmail.text,
                                            password.text));
                                  }
                                  BlocProvider.of<AccountBloc>(context).add(
                                      LoginEvent(
                  ...
                  isAnother?const SizedBox():Padding(
                      ...
                      child:  Text(
                          "NOTE_LOGIN_PAGE".tr(context),textAlign: TextAlign.center,style: TextStyle(fontSize: 12.sp,color:pc2),)),
                ],
              ),
            );
          }

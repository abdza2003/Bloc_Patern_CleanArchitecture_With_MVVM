...
class StoreDayBookedProductsUsecase {
  final ProductsRepository repository;

  StoreDayBookedProductsUsecase(this.repository);

  Future<Either<Failure, Unit>> call(SelectedProductsQuantityModel selectedProducts,String accessToken) async {
    return await repository.storeDayBookedProducts(selectedProducts,accessToken);
  }
}
